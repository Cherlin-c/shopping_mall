...
public class CategoryBrandRelationController {
    ...
    public R listCatelog(@RequestParam Long brandId) {
        return R.ok().put("data", categoryBrandRelationService.list(Wrappers.lambdaQuery(CategoryBrandRelationEntity.class)
